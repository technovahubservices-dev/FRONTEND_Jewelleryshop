...
export default function SideNavBar({ isOpen, onClose }) {
  ...
  const navItems = [
    { name: 'Dashboard', icon: 'fa-solid fa-grip', path: '/admin' },
    ...
    { name: 'Raw Materials', icon: 'fa-solid fa-box-open', path: '/admin/raw-materials' },
    { name: 'Inventory', icon: 'fa-solid fa-boxes-stacked', path: '/admin/inventory' },
  ...
  const footerItems = [
    { name: 'Support', icon: 'fa-regular fa-circle-question', path: '/admin/settings' },
