...
export const DualImageInput = ({ label, value, onChange, fileInputRef, onFileSelected, pendingFile }) => {
      ...
      <div className="flex-1">
        ...
        {pendingFile && (
          <p className="text-[11px] text-amber-700 mt-1 flex items-center gap-1">
            ...
            New file selected: <strong className="truncate max-w-[260px]">{pendingFile.name}</strong> — click Save to apply.
          </p>
        )}
      </div>
      {(value || '') && value.trim() !== '' && (
