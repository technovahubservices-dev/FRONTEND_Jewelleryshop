...
export default function GoogleDrive() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="mb-12">
        <h1 className="text-3xl font-playfair text-emerald-900 font-bold mb-1">Google Drive</h1>
        <p className="text-sm text-gray-500">Manage your Google Drive integration and view connection status.</p>
      </div>
