...
export const contentAPI = {
  ...
  updateHomepageTabWithUpload: (tab, payload, file) => {
    ...
    return api.put('/content/homepage/settings/updateTabWithUpload', formData, {
...
export const storeAPI = {
  getSettings: () => api.get('/store'),
  updateSettings: (data) => api.put('/store', data),
};
